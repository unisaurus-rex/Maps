 ...
 * @param {string} [regionClass] - optional class value to apply to each region path element
 * @desc Given a Leaflet map, draws feature objects in regionData as svg path elements
 */

export default function drawRegions(map, regionData, regionClass) {
  ...
  if(regionClass) {
    feature.attr("class", regionClass)
  }
